...
const buttonPali = document.getElementById("buttonPali");
const result = document.getElementById("resultpali");
...
const resultdispari = document.getElementById("resultdispari");
buttonDispari.addEventListener("click" , function(){
    ...
    */
    ...
    if(Userchoice === "Pari" && SumOfTwoNumber(sum) == true){
      resultdispari.innerHTML = "Hai Vinto!!"
    }else if(Userchoice === "Dispari" && SumOfTwoNumber(sum) == false){
      resultdispari.innerHTML = "Hai Vinto!!"
    }else{
      resultdispari.innerHTML = "Hai Perso!!"
    }
})
